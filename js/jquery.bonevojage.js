      ...
      O: {
        ...
        tryPosition: {
          ...
          bottom: function($el, offset) {
            ...
            if (($el.offset().top + $el.outerHeight() + offset + boneVojage_main.settings.$tooltip.outerHeight()) < (boneVojage_main.settings.$window.scrollTop() + (boneVojage_main.settings.$window.outerHeight() - boneVojage_main.settings.$window.scrollTop())) && (Math.abs($el.offset().left - (Math.abs($el.outerWidth() - boneVojage_main.settings.$tooltip.outerWidth()) / 2)) > boneVojage_main.settings.$window.scrollLeft()) && ($el.offset().left + (Math.abs($el.outerWidth() - boneVojage_main.settings.$tooltip.outerWidth()) / 2) < boneVojage_main.settings.$window.scrollLeft() + boneVojage_main.settings.$window.outerWidth())) {
              return 'bottom';
            } else {
              return 'best';
            }
          ...
          bottom_left: function($el, offset) {
            ...
            if (($el.offset().top + $el.outerHeight() + offset + boneVojage_main.settings.$tooltip.outerHeight()) < (boneVojage_main.settings.$window.scrollTop() + (boneVojage_main.settings.$window.outerHeight() - boneVojage_main.settings.$window.scrollTop())) && ($el.offset().left - boneVojage_main.settings.$tooltip.outerWidth() > boneVojage_main.settings.$window.scrollLeft())) {
              return 'bottom_left';
            } else {
              return 'best';
            }
          ...
          bottom_right: function($el, offset) {
            ...
            if (($el.offset().top + $el.outerHeight() + offset + boneVojage_main.settings.$tooltip.outerHeight()) < (boneVojage_main.settings.$window.scrollTop() + (boneVojage_main.settings.$window.outerHeight() - boneVojage_main.settings.$window.scrollTop())) && ($el.offset().left + $el.outerWidth() + boneVojage_main.settings.$tooltip.outerWidth() < boneVojage_main.settings.$window.scrollLeft() + boneVojage_main.settings.$window.outerWidth())) {
              return 'bottom_right';
            } else {
              return 'best';
            }
