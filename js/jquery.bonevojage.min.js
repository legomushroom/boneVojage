...
return{g_right:d,g_left:e};},makeTooltipPosition:function(h,f,g){var e,d;console.log("pos: "+h+" $el: "+f+" offset: "+g);d=boneVojage_main.O.getPosition(f);
boneVojage_main.settings.$tooltip.css({position:d.fixed});if(h!=="best"){boneVojage_main.settings.$tooltip.attr("class","");boneVojage_main.settings.$tooltip.addClass(h);
}switch(h){case"left":console.log("left");boneVojage_main.settings.$tooltip.css({top:f.offset().top-(boneVojage_main.settings.$tooltip.outerHeight()/2)+(f.outerHeight()/2)-d.normH,left:f.offset().left-(boneVojage_main.settings.$tooltip.outerWidth())-g-d.normY});
break;case"right":console.log("right");boneVojage_main.settings.$tooltip.css({top:f.offset().top-(boneVojage_main.settings.$tooltip.outerHeight()/2)+(f.outerHeight()/2)-d.normH,left:f.offset().left+f.outerWidth()+g-d.normY});
break;case"top":console.log("top");boneVojage_main.settings.$tooltip.css({top:f.offset().top-boneVojage_main.settings.$tooltip.outerHeight()-g-7-d.normH,left:f.offset().left+(f.outerWidth()/2)-(boneVojage_main.settings.$tooltip.outerWidth()/2)-d.normY});
break;case"top_left":console.log("top-left");boneVojage_main.settings.$tooltip.css({top:f.offset().top-boneVojage_main.settings.$tooltip.outerHeight()-7-d.normH,left:f.offset().left-boneVojage_main.settings.$tooltip.outerWidth()-d.normY});
break;case"top_right":console.log("top-right");boneVojage_main.settings.$tooltip.css({top:f.offset().top-boneVojage_main.settings.$tooltip.outerHeight()-7-d.normH,left:f.offset().left+f.outerWidth()-d.normY});
break;case"bottom":console.log("bottom");boneVojage_main.settings.$tooltip.css({top:f.offset().top+f.outerHeight()+g-d.normH,left:f.offset().left+(f.outerWidth()/2)-(boneVojage_main.settings.$tooltip.outerWidth()/2)-d.normY});
break;case"bottom_right":console.log("bottom-right");boneVojage_main.settings.$tooltip.css({top:f.offset().top+f.outerHeight()-d.normH,left:f.outerWidth()+f.offset().left-d.normY});
break;case"bottom_left":console.log("bottom-left");boneVojage_main.settings.$tooltip.css({top:f.offset().top+f.outerHeight()-d.normH,left:f.offset().left-boneVojage_main.settings.$tooltip.outerWidth()-d.normY});
...
},makeModalPosition:function(g){var f,e,h,d,i;console.time("make position takes: ");f=$(g);d=boneVojage_main.O.getPosition(f);boneVojage_main.O.hideModal();
h=$.Deferred();e=0;i=boneVojage_main.options.offset;boneVojage_main.settings.$tooltip.find("li").eq(boneVojage_main.settings.currPoint).addClass("active").siblings().removeClass("active");
boneVojage_main.settings.$body_html.stop(true,false).animate({scrollTop:d.normScrollH,scrollLeft:d.normScrollY},boneVojage_main.options.delay,function(){if(e++===0){h.resolve();
...
boneVojage_main.O.makeTooltipPosition(boneVojage_main.options.position,f,i);return console.timeEnd("make position takes: ");}});return h.promise();}}};
boneVojage_main.options=$.extend({},boneVojage_main.options,a||{});return boneVojage_main.constructor(b);};}).call(this);